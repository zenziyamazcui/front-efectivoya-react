...
export class COMP_aprobado extends Component {
  constructor(props) {
    super(props);
    this.state = {
      h: contants.header2,
      ...
      >
          ...
          <Row className="d-flex justify-content-center">
            <Col xs={12} className="p-2 pb-5 text-center">
              <label style={label_(3, 0, "24px")}>
                ¡Tienes RD$10.000 disponibles!
              </label>
            </Col>
          </Row>
          <Row className="d-flex justify-content-center">
            <Col xs={12} className="text-center">
              <Button style={Btn_(2, 2, 3, "275px")} id="confirmValues">
                Solicitar ahora
              </Button>
            </Col>
          </Row>
        ...
        <div style={{ marginTop: "20px", paddingTop: "20px" }}>
          <Row className="d-flex justify-content-center">
            ...
            <COMPCalculadoras></COMPCalculadoras>
          </Row>
        </div>
      </div>
    );
...
export default withRouter(COMP_aprobado);
